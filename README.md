...
**Interceptor** is a JavaScript library that allows to intercept methods of an existing object, replacing their
behaviours and injecting new methods and properties.
